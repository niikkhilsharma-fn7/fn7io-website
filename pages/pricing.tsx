...
import { PricingHeroSection, PricingPlansSection } from "@/components/Pricing";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Simple, transparent pricing for fn7's AI agents platform. Choose between Basic ($70/month) and Pro ($145/month) plans. Built for founders who ship." />
        <meta name="keywords" content="fn7 pricing, AI agents pricing, go-to-market automation pricing, agentic AI cost, business automation plans" />
        <meta name="author" content="fn7" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="Pricing - fn7 AI Agents Platform" />
        <meta property="og:description" content="Two plans. Built for founders who ship. Start your 3-day free trial today." />
        ...
        <meta name="twitter:description" content="Choose your plan and start automating your go-to-market with AI agents." />
