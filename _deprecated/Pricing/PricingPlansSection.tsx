...
const LinkedInIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M18.5195 0H1.47656C0.660156 0 0 0.644531 0 1.44141V18.5547C0 19.3516 0.660156 20 1.47656 20H18.5195C19.3359 20 20 19.3516 20 18.5586V1.44141C20 0.644531 19.3359 0 18.5195 0ZM5.93359 17.043H2.96484V7.49609H5.93359V17.043ZM4.44922 6.19141C3.49609 6.19141 2.72656 5.42188 2.72656 4.47266C2.72656 3.52344 3.49609 2.75391 4.44922 2.75391C5.39844 2.75391 6.16797 3.52344 6.16797 4.47266C6.16797 5.41797 5.39844 6.19141 4.44922 6.19141ZM17.043 17.043H14.0781V12.4023C14.0781 11.2969 14.0586 9.87109 12.5352 9.87109C10.9922 9.87109 10.7578 11.0781 10.7578 12.3242V17.043H7.79688V7.49609H10.6406V8.80078H10.6797C11.0742 8.05078 12.043 7.25781 13.4844 7.25781C16.4883 7.25781 17.043 9.23438 17.043 11.8086V17.043Z"
      fill="#0077B5"
    />
  </svg>
);
...
const TwitterIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M15.751 0.5H18.816L12.116 8.186L20 19.5H13.826L8.996 12.808L3.464 19.5H0.397L7.542 11.296L0 0.5H6.328L10.714 6.64L15.751 0.5ZM14.616 17.521H16.202L5.454 2.368H3.745L14.616 17.521Z"
      fill="#000000"
    />
  </svg>
);
    ...
    const fetchUserLocation = async () => {
      try {
        ...
        try {
          ...
          console.log(
            "FN7 API not available, trying fallback:",
            fn7Error instanceof Error ? fn7Error.message : "Unknown error"
          );
        }
    ...
    <div className="flex flex-col items-center px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 w-full">
      <div className="flex gap-6 md:gap-8 lg:gap-12 xl:gap-20 items-stretch flex-col lg:flex-row lg:items-stretch">
        ...
        <div className="relative flex flex-col px-4 sm:px-5 md:px-6 lg:px-7 py-6 md:py-7 lg:py-8 bg-white rounded-2xl md:rounded-3xl shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] transition-shadow duration-300 min-h-[750px] md:min-h-[800px] lg:min-h-[850px] w-full lg:w-[520px] xl:w-[575px] max-w-full lg:max-w-none mx-auto lg:mx-0 border border-gray-100">
          <div className="mb-4 md:mb-5 text-2xl sm:text-3xl md:text-4xl font-semibold text-left text-black">Basic</div>
          ...
          <div className="flex gap-2 md:gap-2.5 items-end mb-4 md:mb-5 flex-col sm:flex-row sm:items-end">
            <div className="text-3xl sm:text-4xl md:text-5xl font-semibold text-left sm:text-center text-black">
              ...
              {pricing.basic.base.toLocaleString()}
            </div>
          ...
          <div className="flex justify-between items-center mb-4 md:mb-6">
            ...
            <div className="flex gap-3 md:gap-4 lg:gap-5 items-center">
              ...
              >
                <div className="text-lg text-center text-black">-</div>
              </button>
              <div className="text-lg md:text-xl lg:text-2xl text-center text-black">{basicTeamCount}</div>
              <button
          ...
          <div className="flex justify-between items-center p-3 md:p-4 lg:p-5 mb-5 md:mb-7 lg:mb-9 rounded-xl border border-solid bg-zinc-100 border-neutral-300 h-[50px] md:h-[58px] lg:h-[66px] w-full">
            ...
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-center text-black">
              {pricing.basic.currency}
              {basicTotalPrice.toLocaleString()}
            </div>
          </div>
          <div className="flex flex-col gap-2 sm:gap-3 md:gap-3.5 flex-grow">
            ...
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">40 qualified conversations daily</div>
            </div>
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">Impact Dashboard</div>
            </div>
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
            ...
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">Unlimited response regeneration</div>
            </div>
          </div>
          <button
            onClick={() => {
          ...
          >
            <div className="text-lg md:text-xl lg:text-2xl text-center text-white">Get Beta Access</div>
          </button>
        </div>
        ...
        <div className="relative flex flex-col px-4 sm:px-5 md:px-6 lg:px-7 py-6 md:py-7 lg:py-8 bg-white rounded-2xl md:rounded-3xl border-2 border-[#767070] shadow-2xl hover:shadow-[0_25px_70px_-15px_rgba(0,0,0,0.4)] transition-all duration-300 transform hover:scale-[1.01] md:hover:scale-[1.02] min-h-[750px] md:min-h-[800px] lg:min-h-[850px] w-full lg:w-[520px] xl:w-[575px] max-w-full lg:max-w-none mx-auto lg:mx-0">
          <div className="mb-4 md:mb-5 flex items-center gap-2 md:gap-3">
            <div className="text-2xl sm:text-3xl md:text-4xl text-left text-black font-semibold">Pro</div>
            <div className="inline-flex justify-center items-center px-2.5 sm:px-3 md:px-3.5 pt-1 sm:pt-1.5 pb-1.5 sm:pb-2 rounded-[30px] bg-gradient-to-r from-[#FF6C57] to-[#B56AF1]">
              <div className="text-sm sm:text-base md:text-lg text-center text-white">Recommended</div>
            </div>
          </div>
          <div className="mb-12 md:mb-16 lg:mb-20 text-lg sm:text-xl md:text-2xl text-left text-neutral-500">
            For Growing Teams
          ...
          <div className="flex gap-2 md:gap-2.5 items-end mb-4 md:mb-5 flex-col sm:flex-row sm:items-end">
            <div className="text-3xl sm:text-4xl md:text-5xl font-semibold text-left sm:text-center text-black">
              ...
              {pricing.pro.base.toLocaleString()}
            </div>
            <div className="mb-0 sm:mb-1.5 text-base sm:text-lg md:text-xl text-left sm:text-center text-neutral-500">
              per member / per month
            </div>
          ...
          <div className="flex justify-between items-center mb-4 md:mb-6">
            ...
            <div className="flex gap-3 md:gap-4 lg:gap-5 items-center">
              ...
              <div className="text-lg md:text-xl lg:text-2xl text-center text-black">{proTeamCount}</div>
              <button
          ...
          <div className="flex flex-col gap-2 sm:gap-3 md:gap-3.5 flex-grow">
            ...
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">Unlimited 'Scout More' actions</div>
            </div>
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">Impact Dashboard</div>
            ...
            <div className="flex gap-4 md:gap-5 lg:gap-7 items-start">
              <CheckIcon />
              <div className="flex-1 text-base sm:text-lg md:text-xl text-black">Priority Support</div>
            </div>
          </div>
          <button
            onClick={() => {
            ...
            className="flex justify-center items-center bg-black rounded-xl cursor-pointer h-[50px] md:h-[58px] lg:h-[66px] w-full mt-6 md:mt-8 lg:mt-10 hover:bg-gray-800 transition-colors"
          >
            <div className="text-lg md:text-xl lg:text-2xl text-center text-white">Start 7 Days Free Trial</div>
          </button>
        </div>
      </div>
    </div>
