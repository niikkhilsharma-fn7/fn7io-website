...
const testimonials: Testimonial[] = [
  {
    quote: "I had interns doing this job for me. It still took so much manual effort. Honestly, this is one of the best finds. Please integrate more platforms to connect with.",
    author: "Daniel",
    role: "CEO & CTO",
  },
  {
  ...
  {
    quote: "Ads were really draining me. This is by far the best tool I have come across to find buyers with actual need! I got 87 beta users in 1 week.",
    author: "Daya",
    role: "CEO",
  },
];
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-black text-white rounded-3xl p-6 flex flex-col justify-between min-h-[360px] mx-auto">
                  {/* Quote marks */}
                  <svg width="32" height="26" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-4 opacity-90">
                    <path d="M0.56 26.6V18.08C0.56 15.84 0.76 13.76 1.16 11.84C1.64 9.92 2.4 8.04 3.44 6.2C4.56 4.28 6 2.44 7.76 0.679997L12.44 4.16C11.08 5.67999 10 7.12 9.2 8.48C8.4 9.84 7.84 11.16 7.52 12.44C7.2 13.72 7.04 15.04 7.04 16.4L4.16 14.36H12.8V26.6H0.56ZM20.48 26.6V18.08C20.48 15.84 20.68 13.76 21.08 11.84C21.56 9.92 22.32 8.04 23.36 6.2C24.48 4.28 25.92 2.44 27.68 0.679997L32.36 4.16C31 5.67999 29.92 7.12 29.12 8.48C28.32 9.84 27.76 11.16 27.44 12.44C27.12 13.72 26.96 15.04 26.96 16.4L24.08 14.36H32.72V26.6H20.48Z" fill="white"/>
                  </svg>
