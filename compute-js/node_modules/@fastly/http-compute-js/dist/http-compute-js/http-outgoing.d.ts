...
import type { OutgoingHttpHeaders, OutgoingMessage, IncomingMessage } from 'http';
import { kNeedDrain, kOutHeaders } from './internal-http';
declare const kCorked: unique symbol;
declare const kUniqueHeaders: unique symbol;
declare type WriteCallback = (err?: Error) => void;
declare type OutputData = {
    data: string | Buffer | Uint8Array;
    encoding: BufferEncoding | undefined;
    callback: WriteCallback | undefined;
};
declare type WrittenDataBufferEntry = OutputData & {
    length: number;
    written: boolean;
};
declare type WrittenDataBufferConstructorArgs = {
...
export declare class WrittenDataBuffer {
    ...
    write(data: string | Uint8Array, encoding?: BufferEncoding, callback?: WriteCallback): boolean;
    cork(): void;
    uncork(): void;
    _flush(): void;
...
export declare type HeadersSentEvent = {
    statusCode: number;
    statusMessage: string;
    headers: Record<string, string>;
};
export declare type DataWrittenEvent = {
    index: number;
 ...
 */
export declare class ComputeJsOutgoingMessage extends Writable implements OutgoingMessage {
    ...
    _send(data: string | Uint8Array, encoding?: BufferEncoding | WriteCallback, callback?: WriteCallback): boolean;
    _onDataWritten(index: number, entry: WrittenDataBufferEntry): void;
    _writeRaw(data: string | Uint8Array, encoding?: BufferEncoding | WriteCallback, callback?: WriteCallback): boolean;
    ...
    write(chunk: string | Buffer | Uint8Array, encoding?: BufferEncoding | WriteCallback, callback?: WriteCallback): boolean;
    addTrailers(headers: OutgoingHttpHeaders | ReadonlyArray<[string, string]>): void;
    end(chunk?: string | Buffer | Uint8Array | WriteCallback, encoding?: BufferEncoding | WriteCallback, callback?: WriteCallback): this;
    _finish(): void;
