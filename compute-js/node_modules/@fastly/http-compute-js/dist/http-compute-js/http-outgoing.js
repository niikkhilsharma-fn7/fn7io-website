...
import { checkInvalidHeaderChar, checkIsHttpToken, chunkExpression as RE_TE_CHUNKED, } from './http-common';
 ...
 */
export class ComputeJsOutgoingMessage extends Writable {
    constructor(req) {
        super();
        ...
        this.useChunkedEncodingByDefault = false; // Not liked by viceroy? for now disabling
    ...
    _send(data, encoding, callback) {
        ...
        if (!this._headerSent) {
            ...
            const { statusCode: statusCodeText, statusMessage } = (_b = statusLineResult.groups) !== null && _b !== void 0 ? _b : {};
...
function write_(msg, chunk, encoding, callback, fromEnd) {
    ...
    if (chunk === null) {
        ...
        len = Buffer.byteLength(chunk, encoding !== null && encoding !== void 0 ? encoding : undefined);
    }
    ...
    writableFinished: {
        get() {
            ...
            return (this.finished &&
                this.outputSize === 0 && (this._writtenDataBuffer == null ||
