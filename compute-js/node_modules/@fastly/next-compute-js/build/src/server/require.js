...
exports.readAssetModule = exports.readAssetManifest = exports.getAssetContentType = exports.readAssetFileAsString = exports.readAssetFile = exports.assetFileExists = exports.assetDirectory = exports.assetDirectoryExists = exports.requireFontManifest = exports.requirePage = exports.getPagePath = void 0;
    ...
    const checkManifest = (manifest) => {
        ...
        if (!manifest[curPath] && locales) {
            ...
            for (const key of Object.keys(manifest)) {
                manifestNoLocales[(0, normalize_locale_path_1.normalizeLocalePath)(key, locales).pathname] =
                    pagesManifest[key];
            }
