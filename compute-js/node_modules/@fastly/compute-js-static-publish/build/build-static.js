...
function processModuleTestResult(value) {
    if (value === true) {
        return 'static';
    }
    if (value === false) {
...
export async function buildStaticLoader(commandLineValues) {
    ...
    const excludeTest = (_f = config.excludeTest) !== null && _f !== void 0 ? _f : null;
    const files = results
        .filter(file => {
    ...
    const moduleTest = (_g = config.moduleTest) !== null && _g !== void 0 ? _g : null;
    const knownAssets = {};
...
`;
    ...
    fileContents += '};\n';
    let spaFile = (_h = config.spa) !== null && _h !== void 0 ? _h : false;
    if (spaFile) {
    ...
    let notFoundPageFile = (_j = config.notFoundPage) !== null && _j !== void 0 ? _j : false;
    if (notFoundPageFile) {
    ...
    let autoIndex = (_k = config.autoIndex) !== null && _k !== void 0 ? _k : false;
    fileContents += `\nexport const autoIndex = ${JSON.stringify(autoIndex)};\n`;
    let autoExt = (_l = config.autoExt) !== null && _l !== void 0 ? _l : false;
