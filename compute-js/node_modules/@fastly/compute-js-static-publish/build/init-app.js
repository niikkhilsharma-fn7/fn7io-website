...
function applyPublicDir(optionValue, publicDir) {
    if (optionValue == null) {
        return optionValue;
    }
    return optionValue.replace('[public-dir]', publicDir);
}
export function initApp(commandLineValues) {
    var _a;
    let options = defaultOptions;
    let preset = null;
    const presetName = (_a = commandLineValues['preset']) !== null && _a !== void 0 ? _a : 'none';
    if (presetName !== 'none') {
    ...
    options = {
        ...
        ...pickKeys(['author', 'name', 'description'], packageJson !== null && packageJson !== void 0 ? packageJson : {}),
    ...
    const COMPUTE_JS_DIR = commandLineValues.output;
    ...
    let spaRel = spaFilename != null ? path.relative(path.resolve(), spaFilename) : null;
    if (spaRel != null && !spaRel.startsWith('..')) {
        spaRel = './' + spaRel;
    }
    let notFoundRel = notFoundPageFilename != null ? path.relative(path.resolve(), notFoundPageFilename) : null;
    if (notFoundRel != null && !notFoundRel.startsWith('..')) {
        notFoundRel = './' + notFoundRel;
    }
    console.log('');
    console.log('Public Dir  :', PUBLIC_DIR);
    console.log('Static Dir  :', BUILD_STATIC_DIR !== null && BUILD_STATIC_DIR !== void 0 ? BUILD_STATIC_DIR : '(None)');
    console.log('SPA         :', spaRel !== null && spaRel !== void 0 ? spaRel : '(None)');
    console.log('404 Page    :', notFoundRel !== null && notFoundRel !== void 0 ? notFoundRel : '(None)');
    console.log('Auto-Index  :', autoIndex !== null && autoIndex !== void 0 ? autoIndex : '(None)');
    console.log('Auto-Ext    :', autoExt !== null && autoExt !== void 0 ? autoExt : '(None)');
    console.log('name        :', name);
    console.log('author      :', author);
    console.log('description :', description);
    console.log('Service ID  :', fastlyServiceId !== null && fastlyServiceId !== void 0 ? fastlyServiceId : '(None)');
    console.log('');
